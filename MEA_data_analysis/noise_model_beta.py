...
mockdata_60elecs(output_path="C:\\Users\\pc1rss\\Dropbox\\PhD\\Thesis\\Analysis_Pipeline\\BEL_Datafiles_and_Scripts"
                             "\\BEL_Python_Files\\Neuronal activity analysis\\Mock data\\Plots\\Two_shapes\\")

smaller_noise = noise()

path_zero = "C:\\Users\\Admin\\Dropbox\\PhD\\Thesis\\Analysis_Pipeline\\BEL_Datafiles_and_Scripts\\BEL_Python_Files" \
            "\\Neuronal activity analysis\\Mock data\\Plots\\Noise_play\\"

visualise_noise(output_path=path_zero, duration=smaller_noise[0], noise=smaller_noise[1],
                filename="Smaller_noise")
...
templatesmall = [1.77083333333333, 1.04166666666667, 1.97916666666667, 2.81250000000000, 1.87500000000000, 1.56250000000000,
 ...
 template = [1.77083333333333, 1.04166666666667, 1.97916666666667, 2.81250000000000, 1.87500000000000,
    ...
    template_small = [1.77083333333333, 1.04166666666667, 1.97916666666667, 2.81250000000000, 1.87500000000000, 1.56250000000000,
                    2.70833333333333, 2.81250000000000, 3.12500000000000, 3.33333333333333, 2.50000000000000, 1.14583333333333,
                    1.77083333333333, 2.50000000000000, 0.937500000000000, 0.729166666666667, 1.66666666666667, 2.500000000000,
                    1.35416666666667, 1.97916666666667, 5.93750000000000, 12.5000000000000, 18.5416666666667, 18.4375000000000,
                    4.16666666666667, -12.6666666666667, -22, -28.75, -24, -19.5000000000000,
...
clean = impose_template(noise=smaller_noise, spikes=spikes, template=templateoriginal, template_small=templatesmall)

path_zero = "C:\\Users\\Admin\\Dropbox\\PhD\\Thesis\\Analysis_Pipeline\\BEL_Datafiles_and_Scripts\\BEL_Python_Files" \
            "\\Neuronal activity analysis\\Mock data\\Plots\\Noise_play\\"

visualise_noise(output_path=path_zero, duration=smaller_noise[0], noise=smaller_noise[1],
                filename="THOUSAND_spikes")
